...
const CustomChannelPreview = ({ channel, setActiveChannel, activeChannel }) => {
  ...
  return (
    <button
      ...
      className={`str-chat__channel-preview-messenger transition-colors cursor-pointer flex items-center w-full text-left px-4 py-2 rounded-lg mb-1 font-medium hover:bg-blue-50/80 min-h-9 ${
        isActive
